    ...
    return (
        <header className="flex items-center w-full h-20 min-h-20 border-b border-solid border-neutral-900">
            <div className="flex ml-2">
                <div className="flex items-center justify-center w-10 h-10 min-h-10 rounded-lg bg-neutral-800/50 border-2 border-solid border-neutral-900 cursor-pointer">
